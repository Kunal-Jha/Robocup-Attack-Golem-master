...
public:
    ...
    bool    
    triangulators(PlayerAgent * agent);
    bool
    ApnaDribble(rcsc::PlayerAgent * agent);
    bool
    ThroughPass(rcsc::PlayerAgent *agent);
    int
    ClosestPlayerToVector(rcsc::PlayerAgent *agent, rcsc::Vector2D vector);
    bool 
    getfree(rcsc::PlayerAgent *agent);     
    bool
    amifree(rcsc::PlayerAgent * agent);  
    double 
    ...
    bool
    ultaSectorEmpty(rcsc::PlayerAgent * agent, rcsc::Vector2D target, double buf_degree); 
    int 
    hasball(rcsc::PlayerAgent *agent)  ;
    bool
    converge(rcsc::PlayerAgent *agent);
